                    ...
                    <div class="col-xl-3 col-md-6 mt--30">
                        <div class="feature-box h-100">
                            ...
                            <div class="text">
                                ...
                                <p>Оплата только при получении товара</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 mt--30">
                        <div class="feature-box h-100">
                            ...
                            <div class="text">
                                <h5>Помощь &amp; поддержка</h5>
                                <p>Тел : + 0123.4567.89</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row space-db--30">
                    <div class="col-lg-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img src="obl/2e7832c25574bfa8276f8347672424df.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-lg-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
